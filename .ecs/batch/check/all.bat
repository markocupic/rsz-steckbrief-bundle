...
:: legacy
vendor\bin\ecs check vendor/markocupic/rsz-steckbrief-bundle/src/Resources/contao --config vendor/markocupic/rsz-steckbrief-bundle/.ecs/config/legacy.php
:: templates
vendor\bin\ecs check vendor/markocupic/rsz-steckbrief-bundle/src/Resources/contao/templates --config vendor/markocupic/rsz-steckbrief-bundle/.ecs/config/template.php
::
